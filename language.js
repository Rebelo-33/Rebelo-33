...
const translations = {
  en: {
    ...
    myLists: "My Lists",
    accessList: "Access",
    viewName: "View Drawn Name",
    help: "Help",
    enterPin: "Enter your 4-digit PIN to view your list(s):"
  },
  es: {
    ...
    myLists: "Mis Listas",
    accessList: "Acceder",
    viewName: "Ver Nombre Sorteado",
    help: "Ayuda",
    enterPin: "Ingresa tu PIN de 4 dígitos para ver tus listas:"
  },
  fr: {
    ...
    myLists: "Mes Listes",
    accessList: "Accéder",
    viewName: "Voir le Nom Tiré",
    help: "Aide",
    enterPin: "Entrez votre code PIN à 4 chiffres pour voir vos listes :"
  },
  pt: {
    title: "Amigo Secreto",
    ...
    accessList: "Acessar",
    viewName: "Ver Nome Sorteado",
    help: "Ajuda",
    enterPin: "Digite seu PIN de 4 dígitos para ver suas listas:"
  }
};
